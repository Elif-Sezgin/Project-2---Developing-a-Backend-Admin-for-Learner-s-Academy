...
<div class = "container">
<center>
<h1> Admin UpDate Subjects </h1>

<div class ="search">
<h1> Search Subject</h1>
<form action="./UpdateSubjectController" method="post">
<pre>
Subject ID  :<input type="text" name="rollNumber:" required/>
</pre>
<pre>
...
<tr><td><input type="submit" value="UpDate Subject"/></td><td><input type="button" value="Cancel"></td></tr>
